...
outputFileName = "./image/assum4.eps"
bc = {}
h = [[]]
h1 = []
h2 = []
...
#  mean2.append(np.average(h1))
#  mean2.append(mean2[0] + np.average(h2))
#  mean2.append(mean2[1] + np.average(h3))
#  mean2.append(mean2[2] + np.average(h4))
#  mean2.append(mean2[3] + np.average(h5))
#  mean2.append(mean2[4] + np.average(h6))
#  mean2.append(mean2[5] + np.average(h7))
#  mean2.append(mean2[6] + np.average(h8))
#  mean2.append(mean2[7] + np.average(h9))
#  mean2.append(mean2[8] + np.average(h10))
...
#  plt.plot(x,mean,'-o',label='in low-betweenness link',color='red',markersize=15)
plt.plot(x,mean,'-s',label='The traceroutes passed through a specific link',color='blue',markersize=15)
