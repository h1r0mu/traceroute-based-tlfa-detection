...
#auc vs bc のグラフを作成する
outputFileName = "./image/assum.eps"
bc = {}
h = [[]]
h1 = []
h2 = []
...
mean.append(np.average(h2))
mean.append(np.average(h3))
mean.append(np.average(h4))
mean.append(np.average(h5))
mean.append(np.average(h6))
mean.append(np.average(h7))
mean.append(np.average(h8))
mean.append(np.average(h9))
mean.append(np.average(h10))
...
ax.set_ylabel('Ratio')                  # Y tick label
ax.set_ylim([0,0.4])            # [min, max] value of Y tick
