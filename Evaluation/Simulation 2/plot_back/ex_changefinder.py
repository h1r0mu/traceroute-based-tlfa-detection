...
event = Event.Event()
attackFile = MyConf.ATTACK_FILE + "/caida_original/00373-0099.txt"
noiseFile = MyConf.RANDOM_NOISE + "lambda_000010000-0099.txt"
...
outputFileName = "./image/ChangeFinderExample.eps"
